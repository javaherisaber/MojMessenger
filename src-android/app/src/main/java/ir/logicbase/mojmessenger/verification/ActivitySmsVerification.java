package ir.logicbase.mojmessenger.verification;
...
import ir.logicbase.mojmessenger.home.ActivityHome;
...
public class ActivitySmsVerification extends AppCompatActivity implements
    ...
    public void onContinueButtonClick() {
        ...
        PermissionsRequest.checkReadContactsPermission(this, this);
        swapFragment(currentFragment);
    }
