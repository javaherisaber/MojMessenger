 ...
 * everything associated with packets being sent by network
 */

class MessageHelper {

    static final char HEADER_PAIR_SEPARATOR = ':';
    static final char HEADER_LINE_SEPARATOR = '#';
    static final char HEADER_END_SEPARATOR = '$';
    ...
    static HashMap<String, String> getPacketHeader(String method, int length) {
    ...
    static HashMap<String, String> getPacketHeader(String method, int length, String sender) {
        HashMap<String, String> header = getPacketHeader(method, length);
        header.put(HEADER_KEY_SENDER_PHONE, sender);
        return header;
    }

    static HashMap<String, String> getPacketHeader(String method, int length, String sender, String recipient) {
        HashMap<String, String> header = getPacketHeader(method, length, sender);
